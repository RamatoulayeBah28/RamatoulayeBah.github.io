...
## <img class="img-styling" src="victory.png" alt="Happy squirrel pic showing up when the user guesses the word correctly in our game" width="70%">
...
## <img class="img-styling" src="lose.png" alt="Sad squirrel pic showing up when the user guesses the word wrong after six attempts in our game" width="70%">
...
## <img class="img-styling" src="teamphoto.jpg" alt="My team and I with the happy squirrel pic for when the user guesses the word in our game" width="70%">
